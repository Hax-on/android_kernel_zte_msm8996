...
#define QPNP_LED_PERIOD_2_HI 500   //No.2 period-time =3s=(pause_lo+pause_hi+step),step defined in dtsi file
#define QPNP_LED_PERIOD_2_LO 3000
#define QPNP_LED_PERIOD_2_BLINK 2
//zte notes:
   /*
    deined in leds-qpnp.c. No.1 period-time=6s=(pause_lo+pause_hi+step),all defined in dtsi
    #define QPNP_LED_PERIOD_NO_BLINK  0
    #define QPNP_LED_PERIOD_1_BLINK 1          //led-period defined in dtsi
    #define QPNP_LED_PERIOD_2_BLINK 2          //led-period defined by kernel again
    #define QPNP_LED_PERIOD_2_BLINK_ON_TIME  111   //on time in led_period_two, must same with batteryservices.java
    #define QPNP_LED_PERIOD_2_BLINK_OFF_TIME  111   //off time in led_period_two, must same with batteryservices.java
    */
//zte_led end
